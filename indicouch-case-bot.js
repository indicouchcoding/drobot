...
const CASES = {
  ...
  'Glove Case': {
    ...
    Gold: [
      { weapon: '★ Gloves', name: "Sport Gloves | Vice" },
      { weapon: '★ Gloves', name: "Sport Gloves | Pandora's Box" },
      { weapon: '★ Gloves', name: 'Sport Gloves | Superconductor' },
      { weapon: '★ Gloves', name: 'Sport Gloves | Hedge Maze' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Crimson Kimono' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Emerald Web' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Foundation' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Forest DDPAT' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Spearmint' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Cool Mint' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Turtle' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Boom!' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Cobalt Skulls' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Slaughter' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Leather' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Spruce DDPAT' },
      { weapon: '★ Gloves', name: 'Driver Gloves | King Snake' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Overtake' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Imperial Plaid' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Crimson Weave' },
      { weapon: '★ Gloves', name: 'Hydra Gloves | Emerald' },
      { weapon: '★ Gloves', name: 'Hydra Gloves | Rattler' },
      { weapon: '★ Gloves', name: 'Hydra Gloves | Case Hardened' },
      { weapon: '★ Gloves', name: 'Hydra Gloves | Mangrove' },
    ],
  },
  'Gallery Case': {
    type: 'glove',
    ...
    Gold: [
      { weapon: '★ Gloves', name: 'Sport Gloves | Amphibious' },
      { weapon: '★ Gloves', name: 'Sport Gloves | Arid' },
      { weapon: '★ Gloves', name: 'Sport Gloves | Bronze Morph' },
      { weapon: '★ Gloves', name: 'Sport Gloves | Nocts' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Mogul' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Marble Fade' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Tiger Strike' },
      { weapon: '★ Gloves', name: 'Specialist Gloves | Fade' },
      { weapon: '★ Gloves', name: 'Moto Gloves | POW!' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Polygon' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Transport' },
      { weapon: '★ Gloves', name: 'Moto Gloves | Blood Pressure' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Duct Tape' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Overprint' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Arboreal' },
      { weapon: '★ Gloves', name: 'Hand Wraps | Desert Shamagh' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Diamondback' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Snow Leopard' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Racing Green' },
      { weapon: '★ Gloves', name: 'Driver Gloves | Lunar Weave' },
      { weapon: '★ Gloves', name: 'Broken Fang Gloves | Jade' },
      { weapon: '★ Gloves', name: 'Broken Fang Gloves | Needle Point' },
      { weapon: '★ Gloves', name: 'Broken Fang Gloves | Yellow-banded' },
      { weapon: '★ Gloves', name: 'Broken Fang Gloves | Unhinged' },
    ],
  },
  'Prisma 2 Case': {
